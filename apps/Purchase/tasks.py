...
def generate_pdf(nameUser,purchase_itens,total,date,hour):
    ...
    context = {'nome':nameUser,'purchase_itens':purchase_itens,'total':total,'date':date,'hour':hour}
...
@shared_task()
def confirm_purchase(email, nameUser,purchase_itens):
    try:
        total = None
        is_ticket = False
        ...
        html_content = render_to_string('emails/confirm_purchase.html',{'nome':nameUser,'purchase_itens':purchase_itens,'total':total,'date':date,'hour':hour})
        ...
        path_to_pdf = generate_pdf(nameUser=nameUser,purchase_itens=purchase_itens,total=total,date=date,hour=hour)
