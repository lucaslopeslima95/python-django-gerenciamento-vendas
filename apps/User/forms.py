...
class registerUserForm(forms.Form):
    ...
    cpf = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "CPF","class": "form-control","title":"Cadastro de Pessoa Física","onchange":"validateCPF(this)"}),label="CPF")
    ...
    password_check = forms.CharField(widget=forms.PasswordInput(attrs={"placeholder": "Confirme a senha","class": "form-control","title":"As Senhas Devem ser iguais","onchange":"validatePassword()"}),label="Confirme a Senha",initial="@SejaBemVindo3")
...
class updateUserPasswordForm(ModelForm):
    ...
    password_check = forms.CharField(widget=forms.PasswordInput(attrs={"placeholder": "Confirme a senha","class": "form-control","title":"As Senhas Devem ser iguais","onchange":"validatePassword()"}),label="Confirme a Senha")
    class Meta:
        model = User
