...
class authForm(forms.Form):
    username = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Nome Usuario",
                   "class": "form-control form-control-user",
                   "title": "Nome de Usuario de Acesso ao Sistema"}),
        label="Nome de Usuario")
    password = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"placeholder": "Senha",
                   "class": "form-control form-control-user",
                   "title": "Senha de Acesso ao Sistema"}), label="Senha")
    ...
    cpf = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "CPF",
                   ...
                   "onchange": "validateCPF(this)"}),
        label="CPF")
    email = forms.EmailField(
        widget=forms.EmailInput(
            attrs={"placeholder": "Email",
                   "class": "form-control",
                   "title": "Email deve ser unico"}),
        label="E-mail")
    username = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Nome Usuario",
...
class updateWithoutPasswordForm(ModelForm):
    username = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Nome de Usuario",
                   "class": "form-control",
                   "title": "Nome de Usuario de Acesso ao Sistema"}),
        label="Nome de Usuario")
    email = forms.EmailField(
...
class updateUserPasswordForm(ModelForm):
    password = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"placeholder": "Senha",
                   "class": "form-control",
                   "title": "A Senha deve conter caracteries especiais\
                   numeros letra maiuscula e numeros"}), label="Senha")
    password_check = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"placeholder": "Confirme a senha",
                   "class": "form-control",
